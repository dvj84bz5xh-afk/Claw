...
class OpenRelayManager:
    ...
    def load_config(self):
        ...
        try:
            ...
            print(f"✅ 已加载 {len(self.providers)} 个AI提供商")
    ...
    def get_provider_config(self, tool_name: str) -> Optional[Dict[str, str]]:
        ...
        if not provider:
            print(f"❌ 提供商 {provider_id} 未启用或不存在")
            return None
