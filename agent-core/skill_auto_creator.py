...
import yaml
from multi_solution_generator import ResourceIntensity, RiskLevel, SolutionCandidate, SolutionType
...
"""
    ...
    def search_skills(self, query: str, tags: list[str] | None = None, skill_type: str | None = None) -> list[dict]:
        """搜索技能"""
        index_file = self.skills_dir / "skill_index.json"
