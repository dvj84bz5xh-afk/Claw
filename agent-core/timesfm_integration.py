...
from config_system import AgentCapabilityConfig, ConfigManager, PresetConfigs
from multi_solution_generator import MultiSolutionGenerator, RankingCriteria
from task_patcher import TaskPatcher
from uncertainty_quantifier import MultiViewAnalyzer, UncertaintyQuantifier
from zero_shot_knowledge import ZeroShotKnowledgeBase
...
class TimesFMIntegratedAgent:
    ...
    def generate_multiple_solutions(
        ...
        ranking_criteria: RankingCriteria | None = None
    ) -> dict[str, Any]:
        """
        生成多个解决方案并排序
...
# 便捷函数
def timesfm_process(task: str, context: dict | None = None) -> dict[str, Any]:
    """快速使用TimesFM能力处理任务"""
