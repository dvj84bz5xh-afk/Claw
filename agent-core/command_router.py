...
class CommandRouter:
    ...
    def register_command(self, command: CommandDefinition, handler: Callable | None = None) -> None:
        """注册命令"""
    ...
    def execute_command(self, text: str, context: dict | None = None) -> CommandExecution | None:
        """执行命令"""
    ...
    def bind_help_command(self) -> None:
        """绑定 /help 命令"""
        self.register_simple("help", "显示帮助信息", self.create_help_handler(), hidden=True)
